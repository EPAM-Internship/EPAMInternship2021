...
class LayoutManager(view: CustomView) {
    ...
    val secondLayerAction = LayerAction(1.5f, 1.9999f, insidesBitmap, listOf(boardBottomBitmap, batteryBitmap, boardTopBitmap))
    val thirdLayer = Layer(2.0f, 5.0f, listOf(insidesBitmap, boardBottomBitmap, batteryBitmap, boardTopBitmap))
}